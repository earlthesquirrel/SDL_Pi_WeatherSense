...
def returnPercentLeftInBattery(currentVoltage, maxVolt):
    ...
    if (maxVolt > 11):
        ...
        if (scaledVolts > .9686):
            returnPercent = 10 * \
                (1 - old_div((1.0 - scaledVolts), (1.0 - .9686))) + 90
            return returnPercent

        if (scaledVolts > 0.9374):
            returnPercent = 10 * \
                (1 - old_div((0.9686 - scaledVolts), (0.9686 - 0.9374))) + 80
            return returnPercent

        if (scaledVolts > 0.9063):
            returnPercent = 30 * \
                (1 - old_div((0.9374 - scaledVolts), (0.9374 - 0.9063))) + 50
            return returnPercent

        if (scaledVolts > 0.8749):
            returnPercent = 20 * \
                (1 - old_div((0.8749 - scaledVolts), (0.9063 - 0.8749))) + 11

            return returnPercent

        if (scaledVolts > 0.8437):
            returnPercent = 15 * \
                (1 - old_div((0.8437 - scaledVolts), (0.8749 - 0.8437))) + 1
            return returnPercent

        if (scaledVolts > 0.8126):
            returnPercent = 7 * \
                (1 - old_div((0.8126 - scaledVolts), (0.8437 - 0.8126))) + 2
            return returnPercent

        if (scaledVolts > 0.7812):
            returnPercent = 4 * \
                (1 - old_div((0.7812 - scaledVolts), (0.8126 - 0.7812))) + 1
            return returnPercent
